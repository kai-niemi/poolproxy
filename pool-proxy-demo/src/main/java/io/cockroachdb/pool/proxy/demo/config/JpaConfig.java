package io.cockroachdb.pool.proxy.demo.config;
...
import io.cockroachdb.pool.proxy.hikari.HikariDataSourceProxy;
import io.cockroachdb.pool.proxy.demo.Application;
...
public class JpaConfig {
    ...
    public HikariDataSource targetDataSource() {
        HikariDataSource ds = dataSourceProperties()
                ...
                .build();
        ds.setPoolName("pool-proxy-demo");
        ds.addDataSourceProperty("reWriteBatchedInserts", true);
        ds.addDataSourceProperty("ApplicationName", "pool-proxy-demo");
        return ds;
    }
