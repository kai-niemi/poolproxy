...
import io.cockroachdb.pool.proxy.sandbox.domain.Address;
...
import io.cockroachdb.pool.proxy.sandbox.domain.ShipmentStatus;
import io.cockroachdb.pool.proxy.sandbox.util.RandomData;
